...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_USE_IFRAME_DESC','Start Wirecard Checkout Page in an Iframe in your shop. <strong>Note:</strong> PayPal and Online bank transfer. will always use page redirect.');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_SOFORTUEBERWEISUNG_DESC','Enable payment method Online bank transfer?');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_FINANCIALINSTITUTIONS', 'Financial institution');
